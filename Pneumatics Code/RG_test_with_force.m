...
while(running_test)
    ...
    elseif ~paused && dwell
        ...
        disp('Sitting at negative pressure for 60s');
...
compiledmatrix(testnumber,:) = [ nsp, repeatnumber, min(data), max(data)] 

writematrix(data,['data/',datestr(now,'mm-dd-yyyy-HHMM'),'-RGtest',num2str(nsp),'-',num2str(repeatnumber),'.csv'])%change this to say what pressure is and what number test this is
